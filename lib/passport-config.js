 ...
 */
  const facebookCallbackURL = (process.env.NODE_ENV =='production') ? 'https://event-register-web-project.herokuapp.com/auth/facebook/callback' : 'http://localhost:3000/auth/facebook/callback';
 ...
 * 사용자의 페이스북 계정의 정보가 profile에 담겨온다.
 */
  const kakaoCallbackURL = (process.env.NODE_ENV =='production') ? 'https://event-register-web-project.herokuapp.com/auth/kakao/callback' : 'http://localhost:3000/auth/kakao/callback';
